...
def gen_fix_for_choices_constraint(class_name, name, check, replace=False):
    class Fixes(m.MatcherDecoratableTransformer):
        ...
        def leave_meta(self, node: cst.ClassDef, updated_node: cst.ClassDef):
        ...
        if replace:
            ...
            def fix_existing(self, node: cst.Call, updated_node: cst.Call):
            ...
            def add_new(self, node: cst.Assign, updated_node: cst.Assign):
